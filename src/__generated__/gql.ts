 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query BookingFilter($getBookingFilter: GetBookingFilterDto!) {\n    bookingFilter(getBookingFilter: $getBookingFilter) {\n      bookingTime\n      bookingTime2\n    }\n  }"): (typeof documents)["query BookingFilter($getBookingFilter: GetBookingFilterDto!) {\n    bookingFilter(getBookingFilter: $getBookingFilter) {\n      bookingTime\n      bookingTime2\n    }\n  }"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "\n    query FindAllEvent {\n        findAllEvent {\n        id\n        title\n        location\n        date\n        time\n        posterUrl\n        description\n        }\n    }\n"): (typeof documents)["\n    query FindAllEvent {\n        findAllEvent {\n        id\n        title\n        location\n        date\n        time\n        posterUrl\n        description\n        }\n    }\n"];
