import { BookingTopic } from "@/__generated__/graphql"
...
export const bookingTopic = {
    "TOPIC_1" : BookingTopic.Topic_1,
    "TOPIC_2" : BookingTopic.Topic_1,
    "TOPIC_3" : BookingTopic.Topic_1
}