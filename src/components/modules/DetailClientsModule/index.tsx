...
export const DetailClientsModule: React.FC<DetailClientModule> = ({
  ...
  return booking != null ? (
    <div className="flex flex-col gap-10">
      ...
      <section>
        <h1 className="py-4 text-2xl font-semibold">Reason Apply</h1>
        <p className="w-full">{booking.reasonApply}</p>
      </section>
      <section className="">
                ...
                >
                  <div className="flex flex-col gap-4">
                    <div className="flex flex-col justify-center">
                      ...
                      <p>
                        Silakan tambah log konseling dengan mengisi data
                        berikut.
                      </p>
                    </div>
                    <div>
              ...
              <td className="w-1/2">
                <div>
                  <p className=" font-semibold">
                    ...
                    {monthNames[new Date(val.time.toString()).getUTCMonth()]}{' '}
      ...
      <section className="">
        ...
        <p className="my-3 opacity-70 text-justify">
          ...
          dalam konseling sebaya. Melalui skrining kesehatan mental, konselor
          dapat memperoleh gambaran permasalahan psikologis yang dialami klien.
          Klien dinyatakan memiliki indikasi gangguan psikologis tertentu
          apabila memiliki skor GHQ-12 sama atau lebih besar dari titik potong.
          Selain itu, konselor juga dapat memeriksa respons per item GHQ-12
          untuk mengidentifikasi gejala yang paling menjadi permasalahan klien.
        </p>
